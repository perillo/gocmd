...
// times.
//
// The returned data is consistent with the data generated by the Encode
// function.
...
// Encode encodes env in the same format used by go env -w, so that it is
// compatible with the data read from File.Read.
